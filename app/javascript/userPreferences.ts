...
export interface UserPreferences {
  ...
  navigation: { default_style: MapStyleId; zoom: number; pitch: number; terrain: boolean; nav_fps: number; line_width: number; turn_alert_m: number; turn_hint_m: number; turn_urgent_m: number; turn_repeat_ms: number; turn_marker_size: number }
  display: {
    default_sport: Sport
...
export const DEFAULT_PREFERENCES: UserPreferences = {
  ...
  navigation: { default_style: 'liberty', zoom: 19.5, pitch: 60, terrain: false, nav_fps: 8, line_width: 8, turn_alert_m: 200, turn_hint_m: 200, turn_urgent_m: 15, turn_repeat_ms: 2000, turn_marker_size: 11 },
  display: {
