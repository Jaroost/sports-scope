...
export const DEFAULT_PREFERENCES: UserPreferences = {
  ...
  navigation: { default_style: 'liberty', zoom: 19.5, pitch: 60, terrain: false, nav_fps: 8, line_width: 8, line_color: '#7c3aed', line_opacity: 0.8, turn_alert_m: 200, turn_hint_m: 200, turn_urgent_m: 15, turn_repeat_ms: 2000, turn_marker_size: 11, radar_always_visible: false, radar_close_m: 30 },
  display: {
